# Exact TSP Solver <sup>v1.0.1</sup>
...
find the globally optimal solution for small to medium-sized TSP instances. TSP ORACLE.
...
*   **Production-Grade Go:** Compiled to a single binary, static typing, no external dependencies.
...
```
WARNING: for 30 points there will be approximately so many permutations
...
```
WARNING: for 35 points there will be approximately so many permutations
This may take a considerable amount of time.
Continue? (y/n): y
==================================================
